...
.Scrollbar-Track {
  ...
  position: absolute;
  top: 36px; left: 4px;
  background: transparent url(image/scrollbar_track.gif) no-repeat center center;
}
.Scrollbar-Handle {
    position: absolute;
...
<div id="Scrollbar-Container">
    <img src="up_arrow.gif" class="Scrollbar-Up" />
    <img src="down_arrow.gif" class="Scrollbar-Down" />
    <div class="Scrollbar-Track">
      <img src="scrollbar_handle.gif" class="Scrollbar-Handle" />
    </div>
  </div>
<div class="Container">
